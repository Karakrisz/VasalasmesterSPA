import { c as useRoute, u as useHead, d as useRuntimeConfig, b as _sfc_main$5, a as __nuxt_component_0 } from './server.mjs';
import { defineComponent, withAsyncContext, unref, withCtx, createTextVNode, createVNode, useSSRContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/VasalasmesterSPA/node_modules/vue/index.mjs';
import { ssrInterpolate, ssrRenderComponent } from 'file:///Applications/XAMPP/xamppfiles/htdocs/VasalasmesterSPA/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    if (post == null ? void 0 : post.value) {
      ...
      const metaTags = [
        ...
        { property: "og:title", content: `${post.value.title} - Vasal\xE1s Mester` },
      ...
      useHead({
        title: `${post.value.title} - Vasal\xE1s Mester`,
        meta: metaTags
      });
    }
...
//# sourceMappingURL=_slug_-DNAAvG5-.mjs.map
