...
import { defineComponent, withAsyncContext, withCtx, createTextVNode, createVNode, unref, toDisplayString, useSSRContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/VasalasmesterSPA/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate } from 'file:///Applications/XAMPP/xamppfiles/htdocs/VasalasmesterSPA/node_modules/vue/server-renderer/index.mjs';
import { f as fetchPosts, t as truncateContent } from './utils-CRtLxz24.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` IGEN, Nekem is erre van sz\xFCks\xE9gem! `);
          } else {
            return [
              createTextVNode(" IGEN, Nekem is erre van sz\xFCks\xE9gem! ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-B3SL9ntC.mjs.map
