import { u as useHead, b as _sfc_main$5 } from './server.mjs';
import { useSSRContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/VasalasmesterSPA/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent } from 'file:///Applications/XAMPP/xamppfiles/htdocs/VasalasmesterSPA/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "Aj\xE1nlatk\xE9r\xE9s - Vasal\xE1s Mester",
      meta: [
        {
          name: "description",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="supage-content supage-content--mobileW pr bg-color-w"><h2 class="supage-content__h2 text-transform-uppercase"> \xCDRJON NEK\xDCNK, HAMAR V\xC1LASZOLUNK </h2><p class="supage-content__p"> Amennyiben b\xE1rmilyen k\xE9rd\xE9se mer\xFClne fel, ne habozzon kapcsolatba l\xE9pni vel\xFCnk! \xCDrjon nek\xFCnk b\xE1tran, \xE9s csapatunk igyekszik a lehet\u0151 legr\xF6videbb id\u0151n bel\xFCl v\xE1laszolni minden \xE9rdekl\u0151d\xE9sre. V\xE1rjuk, hogy halljunk \xD6n fel\u0151l! </p><h2 class="supage-content__h2">Kapcsolatfelv\xE9teli \u0171rlap:</h2><ul class="supage-content__ul"><li class="supage-content__ul__li"><strong class="supage-content__ul__li__strong">N\xE9v:</strong> K\xE9rj\xFCk, adja meg a nev\xE9t, hogy szem\xE9lyre szabottan v\xE1laszolhassunk. </li><li class="supage-content__ul__li"><strong class="supage-content__ul__li__strong">Email c\xEDm:</strong> Ide k\xFCldj\xFCk a v\xE1laszunkat \xE9s minden tov\xE1bbi inform\xE1ci\xF3t. </li><li class="supage-content__ul__li"><strong class="supage-content__ul__li__strong">Telefonsz\xE1m:</strong>Ha telefonon szeretne kapcsolatba l\xE9pni, k\xE9rj\xFCk, adja meg telefonsz\xE1m\xE1t. </li><li class="supage-content__ul__li"><strong class="supage-content__ul__li__strong">Legalkalmasabb id\u0151pont a telefonh\xEDv\xE1sra:</strong> T\xFCntesse fel, mikor kereshetj\xFCk meg \xD6nt telefonon. </li><li class="supage-content__ul__li"><strong class="supage-content__ul__li__strong">T\xE1rgy:</strong> Adjon meg egy r\xF6vid t\xE1rgyat, hogy gyorsabban feldolgozhassuk k\xE9rd\xE9s\xE9t. </li><li class="supage-content__ul__li"><strong class="supage-content__ul__li__strong">\xDCzenet:</strong> \xCDrja le k\xE9rd\xE9s\xE9t vagy k\xE9r\xE9s\xE9t r\xE9szletesen. </li></ul><p class="supage-content__p"><i class="supage-content__p__i">A k\xFCld\xE9s gombra kattintva automatikusan elfogadja az Adatv\xE9delmi Szab\xE1lyzatot. </i></p><div class="blog-slug-content__psychologicalBox text-center"><p class="blog-slug-content__psychologicalBox__p"><i class="blog-slug-content__psychologicalBox__i f-500">Nem szeretne \xEDrni? Csak egy h\xEDv\xE1sra vagyunk, hogy mindent elint\xE9zz\xFCnk \xD6nnek!</i></p></div><div class="blog-slug-content__linkBox text-center"><a href="tel:+36307777009" class="blog-slug-content__linkBox__link text-color-w f-700"> IGEN, h\xEDv\xE1s most! </a></div></div></section>`);
    };
  }
};
...
//# sourceMappingURL=ajanlatkeres--ZxnUlhJ.mjs.map
