...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "\xC1rlista - Vasal\xE1s Mester",
      meta: [
        {
          name: "description",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h6 class="prices-content__iTextBox__div__h6 text-transform-uppercase f-700"> LAK\xC1STEXTIL VEGYTISZT\xCDT\xC1S </h6><div class="prices-content__iTextBox__div__prices-box pa"><h3 class="prices-content__iTextBox__div__prices-box__h3 text-center text-color-w"> 1400 Ft-t\xF3l </h3></div></div></div></div></div><div class="blog-slug-content__psychologicalBox text-center"><p class="blog-slug-content__psychologicalBox__p"><i class="blog-slug-content__psychologicalBox__i f-500">K\xE9rd\xE9se van? Csak egy h\xEDv\xE1sra vagyunk, hogy mindent elint\xE9zz\xFCnk \xD6nnek!</i></p></div><div class="blog-slug-content__linkBox text-center">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` IGEN, h\xEDv\xE1s most! `);
          } else {
            return [
              createTextVNode(" IGEN, h\xEDv\xE1s most! ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=arlista-D_pBeoLK.mjs.map
